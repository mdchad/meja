...
import type { Table as TanStackTable, ColumnFiltersState } from "@tanstack/react-table";
    ...
    <div>
      ...
      >
        ...
        <div className="relative">
          <div className="absolute top-2 z-100 w-full overflow-hidden rounded-lg border border-border bg-popover text-popover-foreground shadow-md outline-none animate-in">
